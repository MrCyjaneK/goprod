...
class MainActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        if (logtxt.visibility == View.VISIBLE) {
            logtxt.visibility = View.INVISIBLE
            webview.visibility = View.VISIBLE
        } else {
            logtxt.visibility = View.VISIBLE
            webview.visibility = View.INVISIBLE    
        }
    }
    private fun exec(command: String, params: String): String {
        try {
            logtxt.text = "Running command: " + command + " " + params +"\n"
            ...
            while(line != null) {
                ...
                logtxt.text = logtxt.text.toString() +"\n" + line
                logtxt.text = logtxt.text.toString().takeLast(5120)
